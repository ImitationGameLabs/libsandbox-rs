...
//!
//! Demonstrates using libsandbox to safely execute code generated by AI agents.
//! This is useful for AI coding assistants, autonomous agents, and LLM-based tools.
//!
//! Run with: cargo run --example agent_preset

use libsandbox::config::{NetworkConfig, ResourceConfig};
...
fn main() {
    ...
    let workspace = std::env::temp_dir().join("libsandbox_agent_demo");
...
"#,
    ...
    // Create sandbox using the agent_executor preset, override network + timeout
